...
const InvoiceState = (props) => {
    ...
    const addInvoice = async (formData) => {
        try {
            const response = await axios.post(`${API_URL}/agency/uploadInvoice`, formData, {
                headers: {
    ...
    const updateInvoice = async (currentId, invoiceId, updatedData) => {
        try {
            ...
            await axios.post(`${API_URL}/agency/editInvoice`, {
                currentId,
                invoiceId,
                updatedData
            });
    ...
    const deleteInvoice = async (currentId, invoiceId) => {
        try {
            await axios.post(`${API_URL}/agency/deleteInvoice`, {
                currentId,
                invoiceId
            });
