...
const ResultState = (props) => {
    ...
    const addResult = async (formData) => {
        try {
            const response = await axios.post(`${API_URL}/agency/uploadResult`, formData, {
                headers: {
    ...
    const updateResult = async (currentId, resultId, updatedData) => {
        try {
            await axios.post(`${API_URL}/agency/editResult`, {
                currentId,
                resultId,
                updatedData
            });
    ...
    const deleteResult = async (currentId, resultId) => {
        try {
            await axios.post(`${API_URL}/agency/deleteResult`, {
                currentId,
                resultId
            });
